...
def main():
    ...
    req('.info(' not in appearance,'Appearance explanatory info rows survived')
    ...
    req('case aboutValue(' in settings and 'case telemetryToggle(' in settings,'native About entry types missing')
    ...
    print('  PASS Appearance release-info removal')
    print('  PASS About native version/privacy rows')
