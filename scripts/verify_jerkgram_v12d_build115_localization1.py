...
required_keys = (
    ...
    "editHistory", "saveEditHistory", "showEditHistory", "savedDataHint", "textSending",
    "sendStyle", "sendStyleHint", "deletedReplies", "portableReply",
    "saveDeletedMedia", "portableReplyHint",
    ...
    "oneTimeSave", "oneTimeMedia", "storySave", "appearancePlaceholder", "profileBackground",
    "profileBackgroundEffect", "blurProfileAvatar", "preferAvatarAsBackground",
    "animatedBackground", "colorTint", "reducedBlur", "animatedBackgroundHint",
    "profileEffectDisabledHint", "other", "interface", "messageSeconds", "hideMyPhone",
    "showRamUnderClock", "hidePhoneHint", "presenceHistoryEmpty", "knownUsersNoData",
    "recentEvents", "eventsEmpty", "diagnosticsBufferHint", "information", "telegramId",
