...
def main() -> None:
    ...
    require("strings.jerkgram.authGhostModeStatus(enabled: enabled)" in phone, "localized Ghost Mode state is not wired")
    require("string: strings.jerkgram.authGhostModeHint" in phone, "localized Ghost Mode hint is not wired")
