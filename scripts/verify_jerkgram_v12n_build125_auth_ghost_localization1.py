...
def main() -> None:
    ...
    require("ghostBaseSafeLoginButtonTitle(_ enabled: Bool, strings: PresentationStrings)" in phone, "Ghost Mode title helper does not receive selected-language strings")
    require("ghostBaseSafeLoginButtonTitle(ghostBaseInitialSafeLoginEnabled, strings: strings)" in phone, "Ghost Mode initial title call does not pass strings")
    require("ghostBaseSafeLoginButtonTitle(strongSelf.ghostBaseSafeLoginEnabled, strings: strongSelf.strings)" in phone, "Ghost Mode toggle title call does not pass strings")
    ...
    require("var botLoginButton: String" in strings, "bot-login title localizer missing")
    require("var botLoginAccessibility: String" in strings, "bot-login accessibility localizer missing")
