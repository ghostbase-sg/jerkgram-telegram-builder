...
SOURCE_ORDERED = (
    ...
    "apply_jerkgram_notifications_session_pairing_v01.py",
    "verify_jerkgram_notifications_session_pairing_v01.py",
...
def patch_probe(text: str) -> str:
    ...
    source_payload = (
        SOURCE_MARKER
        + '\necho\necho "== Jerkgram Build140 runtime + passwordless Web Push + backend session pairing =="\n'
...
def main() -> None:
    ...
    print("[Build140 probe hook] existing runtime -> click bridge -> Web Push type10 -> passwordless binding -> backend session pairing -> identity 140 -> source gate -> Bazel -> physical identity 140")
