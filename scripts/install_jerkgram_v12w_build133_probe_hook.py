...
def patch_probe(text: str) -> str:
    ...
    source_payload = (
        SOURCE_MARKER
        + '\necho\necho "== Jerkgram Build140 runtime + native Type1 push diagnostic =="\n'
...
def main() -> None:
    ...
    print("[Build140 probe hook] existing runtime -> click bridge -> native Type1 diagnostic -> identity 140 -> source gate -> Bazel -> physical identity 140")
