...
class Build125CanaryPublicationTests(unittest.TestCase):
    def test_workflow_publishes_only_build125_artifact(self):
        workflow = (ROOT / ".github/workflows/build.yml").read_text(encoding="utf-8")
        self.assertIn("Jerkgram 12.9.2 Build125 Canary", workflow)
        self.assertIn("Jerkgram-Build125-canary", workflow)
        self.assertIn("jerkgram_publish_build125_artifact.py", workflow)
